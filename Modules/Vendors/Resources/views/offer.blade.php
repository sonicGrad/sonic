                        ...
                        <div class="row">
                            ...
                            <div class="col-md">
                                <div class="form-group">
                                    ...
                                    <select id="status_id" class="form-control js-example-basic-single"name="status_id">
                                        <option></option>
                                        <option value="1">{{__('Persentage')}}</option>
                                        <option value="3">{{__('Free Shippeng')}}</option>
                                    </select>
                                </div>
                            </div>
