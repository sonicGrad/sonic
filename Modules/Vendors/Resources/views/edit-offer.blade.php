    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <select name="vendor_id" id="vendor_id" class="form-control ">
                ...
                <option value="{{ $vendor->id }}" @if ($vendor->id == $offer->vendor_id) selected @endif >{{ $vendor->company_name }}</option>
                 @endforeach
            </select>
            <p class="invalid-feedback"></p>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <select name="status" id="status" class="form-control ">
                ...
                <option value="2" @if($offer->status == '2') selected @endif>{{__('Reject')}}</option>
            </select>
            <p class="invalid-feedback"></p>
        </div>
    </div>
...
<script>
    ...
    $.ajax({
        url: $("meta[name='BASE_URL']").attr("content") + '/admin/offers/' + $id,
        type: 'PUT',
        data:data
    })
