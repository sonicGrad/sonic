                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">{{__('Campany Name')}}</label>
                                        <input type="text" value="" class="form-control" name="company_name" placeholder="{{__('Campany Name')}}">
                                    </div>
                                </div>
                                <div class="col-md">
                                    <div class="form-group">
    ...
    $(function () {
        ...
        searching: false,
          ...
          columns: [
              ...
              {data: 'company_name', name: 'company_name', defaultContent: "__"},
        ...
        $('a[data-action="destroy"]').on('click', function (e) {  
            ...
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        url: $("meta[name='BASE_URL']").attr("content") + '/admin/vendor_types/' + $id,
                        type: 'DELETE',
                        data:{
