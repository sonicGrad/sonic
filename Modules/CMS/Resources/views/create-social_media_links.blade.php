...
<form id="target" action="{{route('roles.store')}}" method="post" class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <input type="text" required class="form-control " name="type_ar" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <input type="text" required class="form-control " name="type_en" >
            <p class="invalid-feedback"></p>
        </div>
...
<script>
    ...
    $.post($("meta[name='BASE_URL']").attr("content") + "/admin/social_media_links", data,
